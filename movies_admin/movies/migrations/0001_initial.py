# Generated by Django 3.2 on 2023-09-04 17:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('MV', 'Movie'), ('TV', 'Tv Show')], default='MV', max_length=2)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('AC', 'Actor'), ('WR', 'Writer'), ('DR', 'Director')], default='AC', max_length=2)),
            ],
            options={
